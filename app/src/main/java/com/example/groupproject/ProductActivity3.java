    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(ProductActivity3.this, MainActivity.class);
        ...
        map.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent1 = new Intent(ProductActivity3.this, MapActivity.class);
                startActivity(intent1);
            }
        });
        faq.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent1 = new Intent(ProductActivity3.this, HelpMainActivity.class);
                startActivity(intent1);
            }
        });
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent1 = new Intent(ProductActivity3.this, SellActivity.class);
                startActivity(intent1);
            }
        });
